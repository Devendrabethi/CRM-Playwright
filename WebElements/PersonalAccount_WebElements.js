...
class PersonalAccount_WebElements
{
    constructor()
    {
        ...
        this.AccountType_Dropdown = "//button[@aria-label='Account Type']"
        this.Select_Personal =      "//div[text()='Personal']"
...
//Event Comp Type
        ...
        this.Select_Next_Auct_Comp_Type = "(//button[contains(@aria-label,'Comp Type')])[2]"
        this.Select_CompType = "//div[contains(text(),'Comp Consignor')]"
...
//New VIP Advance Registration 
        ...
        this.Create_Package = " //button[@aria-label='Create Package']"
        this.Event = "//input[@aria-label='Event, Lookup']"
        this.Select_Tracking_Event = "//div[@aria-label='Event Lookup results']/ul/li"
        this.Select_PackageType_Dropdown = "//button[@aria-label='Package Type']"
        this.Select_BidderCredentialPackage = "//div[contains(@id,'fluent-option') and text()='Bidder Credential Package']"
        this.Select_Carrier = "//button[@aria-label='Carrier']"
        this.Select_FedEx = "//div[contains(@id,'fluent-option') and text()='FedEx']"
        this.Select_USPS = "//div[contains(@id,'fluent-option') and text()='United States Postal Service (USPS)']"
        this.Select_UPS = "//div[contains(@id,'fluent-option') and text()='United Postal Service (UPS)']"
        this.Tracking_Number= "//span[@title='Tracking Number']/following::input[1]"
        this.Recipient_Company_text = "//div[@title='Recipient Company']"
        this.Shipper_City = "//span[@title='City']"
        this.Select_ImageType_Dropdown = "//button[@aria-label='Image Type']"
        this.Select_PDF = "//div[contains(@id,'fluent-option') and text()='PDF']"
        this.Weight = "//span[@title='Weight']/following::input[1]" 
        this.ImageType_Text = "//div[@title='Image Type']"
        this.OneRate = "//input[contains(@aria-label,'Use one rate')]"
        this.Select_Packaging = "//button[@aria-label='Packaging']"
        this.Select_ServiceType = "//button[@aria-label='Service Type']"
        ...
        this.Refresh_Tracking = "//ul[contains(@data-lp-id, 'package') and @aria-label='Commands']/li/div/button[@aria-label='Refresh']"//"//button[@title='Refresh']"//"(//button[@title='Refresh'])[2]"
