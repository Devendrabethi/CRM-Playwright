...
class BidderOpportunity_WebElements
{
    constructor()
    {
        ...
        this.Return_Type = "//div[@aria-label='Editable Grid']/div/div/div[@aria-label='Bid Limit Deposits']/div[@aria-label='Data']/div[@title='---']"
       ...
       //this.Close_Tracking_BidderPage ="//button[@aria-label='Close']"
        ...
        this.AddFees_button = "//button[@aria-label='Add Fees']"
        this.Close_AddFees = "//button[@title='Close']"
        this.frame_Available_Products = "//iframe[contains(@title,'Available Products')]"
        this.FirstProduct = "(//button[@class='btn-add'])[1]"
        this.SecondProduct = "(//button[@class='btn-add'])[2]"
        this.ThirdProduct = "(//button[@class='btn-add'])[3]"
