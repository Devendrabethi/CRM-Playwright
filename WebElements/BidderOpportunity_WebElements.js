...
class BidderOpportunity_WebElements
{
    constructor()
    {
        ...
        this.Delete_BidderPackage= "//ul[@title='Bidder Package Type']/li/button[contains(@aria-label,'Delete')]"
        ...
        this.Select_Bid_LimitType_dropdown = "//button[@aria-label='Bid Limit Type']"
        this.SelectBid_LimitType_Woodside = "//div[text()='Woodside']"
        this.Bid_Limit_Value = "//input[@aria-label='Bid Limit Value']"
        this.Bid_Limit_Estimation = "//input[@aria-label='Bid Limit Estimated']"
        this.Select_Interner_Bidder = "//button[@aria-label='Internet Bidder']"
        this.Select_Yes_Push = "//div[text()='Yes & Pushed']"
        this.ConsignmentValue_Button = "//span[text()='Consignment Values']"
        ...
        this.Select_second_field = "//span[text()='Wire Transfer']"
        this.Return_Type = "//div[@title='---']"
        ...
        this.Select_Absentee_Bid = "//button[@aria-label='Absentee Bids']"
        this.Select_Phone_AbsenteeBid = "//div[text()='Phone']"
        this.Select_Representative_AbsenteeBid = "//div[text()='Absentee Representative']"
        this.Select_Internet = "//div[text()='Internet']"
        ...
        this.PhoneObserver = "//input[contains(@aria-label,'Phone Observer')]"
...
//Create Package
       ...
       //this.Close_Tracking_BidderPage ="//button[@aria-label='Close']"
        ...
        this.Upload_BidderRegisterDocument = "//input[@id='fileInput']"
        this.Bidder_Registerdoc_Refresh = "//ul[@aria-label='Opportunity Document Commands']/li[2]/div/button[@aria-label='Refresh']"
        ...
        this.PaymentTab_ThirdInvoice = "(//label[@aria-label='Visa'])[3]"
//wristband
        ...
        this.PaymentOk = "//button[@title='OK']"
