...
class ConsignmentManager_WebElements
{
    constructor() 
    {
        ...
        this.Day1AM = "//button[contains(text(), 'AM ')]"
        ...
        this.FirstAssign_Button = "//table[@id='rightTab_ALLDAYS_table']/tbody/tr[1]/td[7]"
        this.SelectAssign = "//table[@id='rightTab_ALLDAYS_table']/tbody/tr[1]/td[7]/div/div/button[text()='Assign']"
        ...
        this.Close_Docket = "(//button[@aria-label='Close'])[3]"
        this.CloseMainDocket = "(//button[@aria-label='Close'])[2]"
