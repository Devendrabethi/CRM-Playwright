...
class NewConsignmentVehicle_WebElement
{
    constructor()
    {
        ...
        this.Featured_Consignment_Toggle= "//button[contains(@aria-label,'Featured Consignment')]"
        this.Has_Video_Toggle = "//button[contains(@aria-label,'Has Feature')]"
        this.Social_Media_Toggle ="//button[contains(@aria-label,'Social Media')]"
        this.Preview_List_Toggle ="//button[contains(@aria-label,'Preview List')]"
