...
class MediCredentialPage 
{
    ...
    async manager()
    {
        ...
        await this.page.locator(this.mediacredential_webElements.Select_All_Media_Credentials_CurrentEvent).click()
        await this.page.waitForTimeout(4000)
        await this.page.screenshot({ path: './ScreenShot/86.1 All Media Credentials - Current Event.png', fullPage: true})
        await this.page.locator(this.mediacredential_webElements.All_Media_Credentials_CurrentEvent).click()
    ...
    async MediaCredential()
    {
       ...
       await this.page.waitForTimeout(4000)
       await this.page.locator(this.mediacredential_webElements.Select_CredentidalStatus).click()
       await this.page.locator(this.mediacredential_webElements.Approve_Button).click()
