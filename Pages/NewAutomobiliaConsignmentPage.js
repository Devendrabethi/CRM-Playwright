...
class NewAutomobiliaConsignmentPage
{
    ...
    async ApplicationStatus()
    {
        ...
        await this.page.waitForTimeout(1000)
        await this.page.locator(this.newconsignmentvehicle_webelement.ApproximateWeight).click()
...
//salefee tab
       ...
       // await frameCard.locator(this.bidderopportunity_webelements.CardNum).click()
        ...
        await this.page.waitForTimeout(3000)
        await this.page.screenshot({ path: './ScreenShot/109 LotInvoiceTab.png', fullPage: true})
        ...
        await this.page.waitForTimeout(2000)
        await this.page.screenshot({ path: './ScreenShot/110 PaymentTableWithPaymentCreated.png', fullPage: true})
        await this.page.locator(this.bidderopportunity_webelements.GoBack_btn).click()
        await this.page.waitForTimeout(2000)
        await this.page.locator(this.bidderopportunity_webelements.GoBack_btn).click()
        await this.page.waitForTimeout(3000)
        await this.page.screenshot({ path: './ScreenShot/111 LotSaleFeeTab.png', fullPage: true})
