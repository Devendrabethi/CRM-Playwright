...
class ConsignmentManagerPage
{
    ...
    async Events()
    {
       ...
       await this.page.locator(this.consignmentManager_webElements.Select_Bidder_Event).click()
       await this.page.waitForTimeout(4000)
       await this.page.screenshot({ path: './ScreenShot/75.1 Bidder Event.png', fullPage: true})
       await this.page.locator(this.consignmentManager_webElements.Select_SetupTake_Event).click()
       await this.page.waitForTimeout(2000)
       await this.page.locator(this.consignmentManager_webElements.NewTask).click()
       await this.page.waitForTimeout(2000)
       await this.page.locator(this.consignmentManager_webElements.Subject).fill(this.testdata.Subject)
       await this.page.locator(this.consignmentManager_webElements.Event_Description).fill(this.testdata.Description)
       await this.page.locator(this.consignmentManager_webElements.DateOfDue).click()
      ...
      // await this.page.locator(this.consignmentManager_webElements.Select_ConsignmentStage).selectOption(this.testdata.Consignment_Stage)
       ...
       await this.page.waitForTimeout(2000)
       await this.page.locator(this.consignmentManager_webElements.EditButton).click()
       await this.page.locator(this.consignmentManager_webElements.Subject).fill(this.testdata.Updated_Subject)
       await this.page.locator(this.consignmentManager_webElements.SaveandClose_Edittask).click()
       await this.page.waitForTimeout(4000)
       await this.page.locator(this.consignmentManager_webElements.Select_FirstTask).click()
       await this.page.locator(this.consignmentManager_webElements.Mark_Complete).click()
       //await this.page.locator(this.consignmentManager_webElements.DeletePopup).click()
       await this.page.waitForTimeout(2000)
       await this.page.locator(this.consignmentManager_webElements.Select_FirstTask).click()
       await this.page.locator(this.consignmentManager_webElements.Refresh_SetupTak).click()
       await this.page.waitForTimeout(2000)
       await this.page.screenshot({ path: './ScreenShot/75.2 Setup Task Event.png', fullPage: true})
    }
    async Dockets()
    {
      await this.page.waitForTimeout(4000)
      await this.page.locator(this.consignmentManager_webElements.Docket).click({timeout:90000})
      const frame = await this.page.frameLocator(this.consignmentManager_webElements.iframe_DocketLaunch)
                    if(!frame) throw new Error('Iframe not found')
      await this.page.waitForTimeout(4000)
      await frame.locator(this.consignmentManager_webElements.SelectStore).selectOption(this.testdata.StoreAutomobilia)
      await this.page.waitForTimeout(1000)
      await this.page.screenshot({ path: './ScreenShot/75.5 Automobilia count.png', fullPage: true})
      await this.page.waitForTimeout(3000)
      await frame.locator(this.consignmentManager_webElements.SelectStore).selectOption(this.testdata.StoreVehicle)
      await this.page.waitForTimeout(1000)
      await this.page.screenshot({ path: './ScreenShot/75.6 Vehicle count.png', fullPage: true})
      ...
      try 
         {
            ...
            await frame1.locator(this.consignmentManager_webElements.FirstCIdCheckbox).click()
            await this.page.waitForTimeout(1000)
            await frame1.locator(this.consignmentManager_webElements.FirstAssign_Button).click({timeout:10000})
            await this.page.waitForTimeout(1000)
            await frame1.locator(this.consignmentManager_webElements.SelectAssign).click()
            const frame2 = this.page.frameLocator(this.consignmentManager_webElements.iframeAssignLot)
            if (!frame2) {throw new Error('Iframe not found')}
            await this.page.waitForTimeout(5000)
            await frame2.locator(this.consignmentManager_webElements.AutoAssign).click()
            await this.page.waitForTimeout(2000)
    ...
    async MarkettingTab()
    {
      ...
      //   await this.page.screenshot({ path: './ScreenShot/ChariryInside.png', fullPage: true})
       // await this.page.locator(this.consignmentManager_webElements.GoBack_Button).click()
        await this.page.waitForTimeout(2000)
        await this.page.locator(this.consignmentManager_webElements.Overview_Tab).click()
        await this.page.waitForTimeout(2000)
        await this.page.locator(this.consignmentManager_webElements.Marketting_Tab).click()
        await this.page.waitForTimeout(4000)
    }
