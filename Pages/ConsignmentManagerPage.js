...
class ConsignmentManagerPage
{
    ...
    async Events()
    {
      ...
      // await this.page.locator(this.consignmentManager_webElements.NewDocket).click()
      // await this.page.locator(this.consignmentManager_webElements.Name).fill(this.testdata.CustomerName)
      // await this.page.locator(this.consignmentManager_webElements.BeginingLot).press('Tab')
      // await this.page.locator(this.consignmentManager_webElements.BeginingLot).fill(this.testdata.Lot_starting)
      // await this.page.locator(this.consignmentManager_webElements.EndingLot).press('Tab')
      // await this.page.locator(this.consignmentManager_webElements.EndingLot).fill(this.testdata.Lot_Ending)
      // await this.page.locator(this.consignmentManager_webElements.StartTime_Calender).click()
      // await this.page.locator(this.consignmentManager_webElements.CurrentDate).click()
      // await this.page.waitForTimeout(1000)
      // await this.page.locator(this.consignmentManager_webElements.Save_Button).click()
      // await this.page.waitForTimeout(1000)
      // await this.page.locator(this.consignmentManager_webElements.Saveandclose_Docket).click()
      // await this.page.waitForTimeout(4000)
