...
//Aggreement Tab
   ...
   async BidderHamburgerMenu ()
  {
   ...
   async ConsignmentHamburgerMenu()
   {
                ...
                await this.page.waitForTimeout(4000)
                await this.page.locator(this.bidderopportunity_webelements.BidderPalmBeach2026Dropdown).click()  //PB2026 Bidder start
                ...
                await this.page.locator(this.bidderopportunity_webelements.Automobilia).click()
                await this.page.waitForTimeout(8000)
                await this.page.locator(this.bidderopportunity_webelements.BidderPalmBeach2026Dropdown).click()  //PB2026 Bidder end
                await this.page.waitForTimeout(1000)
                await this.page.locator(this.bidderopportunity_webelements.ConsignmentPalmBeach2026Dropdown).click() // PB 2026 Consignment start
                await this.page.locator(this.bidderopportunity_webelements.MenuAllOpportunity).click()
                await this.page.waitForTimeout(8000)
                ...
                await this.page.locator(this.bidderopportunity_webelements.Automobilia).click()
                await this.page.waitForTimeout(8000)
                await this.page.locator(this.bidderopportunity_webelements.ConsignmentPalmBeach2026Dropdown).click()  // PB 2026 Consignment end
                await this.page.waitForTimeout(1000)
                await this.page.locator(this.bidderopportunity_webelements.BidderColumbus2026Dropdown).click() //Columbus 2026 Bidder start
                await this.page.locator(this.bidderopportunity_webelements.MenuSubmit).click()
                await this.page.waitForTimeout(8000)
                await this.page.locator(this.bidderopportunity_webelements.MenuInReview).click()
                await this.page.waitForTimeout(8000)
                ...
                await this.page.locator(this.bidderopportunity_webelements.Automobilia).click()
                await this.page.waitForTimeout(8000)
                await this.page.locator(this.bidderopportunity_webelements.BidderColumbus2026Dropdown).click()  //Columbus 2026 Bidder end
                await this.page.waitForTimeout(1000)
                await this.page.locator(this.bidderopportunity_webelements.ConsignmentColumbus2026Dropdown).click()  // Columbus 2026 Consignment start
                await this.page.locator(this.bidderopportunity_webelements.MenuAllOpportunity).click()
                await this.page.waitForTimeout(8000)
                await this.page.locator(this.bidderopportunity_webelements.MenuOpportunityWithOpenTask).click()
                await this.page.waitForTimeout(8000)
                ...
                await this.page.locator(this.bidderopportunity_webelements.Automobilia).click()
                await this.page.waitForTimeout(8000)
                await this.page.locator(this.bidderopportunity_webelements.ConsignmentColumbus2026Dropdown).click()  // Columbus 2026 Consignment end
                await this.page.waitForTimeout(1000)
