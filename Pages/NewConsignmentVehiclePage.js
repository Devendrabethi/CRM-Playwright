...
class NewConsignmentVehiclePage
{
    ...
    async vehicledeatails()
    {
        ...
        await this.page.locator(this.newconsignmentvehicle_webelement.Transmission_Type_dropdown).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_TransactionType).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Transmission_Speed_dropdown).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Speed).click()
    ...
    async Mileage()
    {
        await this.page.locator(this.newconsignmentvehicle_webelement.Odometer_Type_dropdown).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Miles).click()
    ...
    async SaleDetails()
    {
        await this.page.locator(this.newconsignmentvehicle_webelement.Sale_Type_dropdown).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_SaleType).click()
    ...
    async ComparisionTab()
    {
        ...
        await this.page.waitForTimeout(2000)
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Source).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_BarrettJackson).click()
        await this.page.waitForTimeout(500)
        ...
        await this.page.locator(this.newconsignmentvehicle_webelement.Additoinal_Source_button).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Source).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_BAT).click()
        await this.page.waitForTimeout(500)
        ...
        await this.page.locator(this.newconsignmentvehicle_webelement.Additoinal_Source_button).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Source).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Hagerty).click()
        await this.page.waitForTimeout(500)
        ...
        await this.page.locator(this.newconsignmentvehicle_webelement.Additoinal_Source_button).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Source).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_NADA).click()
        await this.page.waitForTimeout(500)
        ...
        await this.page.locator(this.newconsignmentvehicle_webelement.Additoinal_Source_button).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Source).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_CPI).click()
        await this.page.waitForTimeout(500)
        await this.page.locator(this.newconsignmentvehicle_webelement.Source_Fair).fill(this.testdata.Source_Fair)
        await this.page.waitForTimeout(500)
        await this.page.locator(this.newconsignmentvehicle_webelement.Source_Good).fill(this.testdata.Source_Good)
        ...
        await this.page.locator(this.newconsignmentvehicle_webelement.Additoinal_Source_button).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Source).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_HIBID).click()
        await this.page.waitForTimeout(500)
        ...
        await this.page.locator(this.newconsignmentvehicle_webelement.Additoinal_Source_button).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Source).click()
        await this.page.locator(this.newconsignmentvehicle_webelement.Select_Other).click()
        await this.page.waitForTimeout(500)
    ...
    async ApplicationStatus()
    {
        ...
        await this.page.waitForTimeout(3000)
        await this.page.locator(this.newconsignmentvehicle_webelement.Featured_Consignment_Toggle).click() 
        await this.page.waitForTimeout(1000)
        await this.page.locator(this.newconsignmentvehicle_webelement.Has_Video_Toggle).click() 
        await this.page.waitForTimeout(1000)
        await this.page.locator(this.newconsignmentvehicle_webelement.Social_Media_Toggle).click() 
        await this.page.waitForTimeout(1000)
        await this.page.locator(this.newconsignmentvehicle_webelement.Preview_List_Toggle).click() 
        await this.page.waitForTimeout(1000)
        await this.page.locator(this.newconsignmentvehicle_webelement.Web_Hidden_Toggle).click() 
        await this.page.waitForTimeout(1000)
        await this.page.locator(this.newconsignmentvehicle_webelement.Print_Media_Toggle).click() 
        await this.page.waitForTimeout(1000)
